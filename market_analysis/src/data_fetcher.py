...
class MarketDataCenter:
    ...
    def get_market_indices(self):
        ...
        try:
            ...
            target_map = {
                '000001': '上證指數', '399001': '深證成指', 
                '399006': '創業板指', '000688': '科創50', 
                '000016': '上證50', '000300': '滬深300'
            }
            indices = []
            if not df.empty:
    ...
    def get_all_market_data(self):
        ...
        try:
            ...
            if not df.empty:
                ...
                return df.rename(columns=mapping)[[c for c in mapping.values() if c in df.columns]], "EastMoney"
        except: pass
